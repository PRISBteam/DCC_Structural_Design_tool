...
/*
    ...
    // special INDUCED cell sequences
        if (new_cells_design.Get_n_induced_sequence().size() > 0)
            for (auto rvit: new_cells_design.Get_n_induced_sequence()) Out_ind_scells_file << rvit + 1 << " "; /// vit + 1 !!! for compatibility with the Neper output
        Out_ind_scells_file << endl;
        if (new_cells_design.Get_e_induced_sequence().size() > 0)
            for (auto rvit: new_cells_design.Get_e_induced_sequence()) Out_ind_scells_file << rvit + 1 << " "; /// vit + 1 !!! for compatibility with the Neper output
        Out_ind_scells_file << endl;
        if (new_cells_design.Get_f_induced_sequence().size() > 0)
            for (auto rvit: new_cells_design.Get_f_induced_sequence()) Out_ind_scells_file << rvit + 1 << " "; /// vit + 1 !!! for compatibility with the Neper output
        Out_ind_scells_file << endl;
        if (new_cells_design.Get_p_induced_sequence().size() > 0)
            for (auto rvit: new_cells_design.Get_p_induced_sequence()) Out_ind_scells_file << rvit + 1 << " "; /// vit + 1 !!! for compatibility with the Neper output
 ...
 */
    ...
    if (Out_scells_file) {
        ...
        // special INDUCED cell sequences
        if (new_cells_design.Get_n_induced_sequence().size() > 0)
            for (auto rvit: new_cells_design.Get_n_induced_sequence()) Out_ind_scells_file << rvit + 1 << endl;; /// vit + 1 !!! for compatibility with the Neper output
        Out_ind_scells_file << endl;
        if (new_cells_design.Get_e_induced_sequence().size() > 0)
            for (auto rvit: new_cells_design.Get_e_induced_sequence()) Out_ind_scells_file << rvit + 1 << endl;; /// vit + 1 !!! for compatibility with the Neper output
        Out_ind_scells_file << endl;
        if (new_cells_design.Get_f_induced_sequence().size() > 0)
            for (auto rvit: new_cells_design.Get_f_induced_sequence()) Out_ind_scells_file << rvit + 1 << endl;; /// vit + 1 !!! for compatibility with the Neper output
        Out_ind_scells_file << endl;
        if (new_cells_design.Get_p_induced_sequence().size() > 0)
            for (auto rvit: new_cells_design.Get_p_induced_sequence()) Out_ind_scells_file << rvit + 1 << endl; /// vit + 1 !!! for compatibility with the Neper output
